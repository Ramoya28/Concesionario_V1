...
public class Auto implements Serializable{
    ...
    public Auto(String marca, String modelo, String estilo, String combustible, String transmision, String provincia, int ano, float precio, String rutaImagen, boolean activo) {
        this.marca = marca;
        this.modelo = modelo;
        this.estilo = estilo;
